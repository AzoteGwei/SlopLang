...
The HTTP development server (`src/slop_http.erl`) and the web framework
(`sloplib/web.slop`) are original SlopLang code (0BSD); no third-party
web libraries are used.
