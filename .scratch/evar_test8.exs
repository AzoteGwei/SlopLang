...
wrapped = :cerl.c_apply(:cerl.c_fun([], inner), [])
outer = :cerl.c_try(wrapped, [v.(:"_4")], v.(:"_4"),
  [v.(:"_7"), v.(:"_6"), v.(:"_5")], mkcase.(v.(:"_6"), v.(:"_7"), v.(:"_5")))
test.("fun-wrapped inner, both-case", outer)

# and with destructuring case after
destr = :cerl.c_let([v.(:"_9")], wrapped,
...
outer2 = :cerl.c_try(seq.(destr, :cerl.abstract(:body)), [v.(:"_4")], v.(:"_4"),
  [v.(:"_7"), v.(:"_6"), v.(:"_5")], mkcase.(v.(:"_6"), v.(:"_7"), v.(:"_5")))
test.("fun-wrapped + destructured", outer2)
